...
from inventory_tracking.hover import capture_selection, parse_hover, scan_hover
...
def test_discovery_accepts_live_reader_capture_summary(tmp_path):
    ...
    from inventory_tracking.hover_probe import discover_hover
...
def test_unexpected_probe_error_publishes_failed_completion(tmp_path, monkeypatch):
    ...
    from inventory_tracking import hover_probe
...
def test_indexed_hover_reads_selected_slot_and_rejects_changed_selector():
    from inventory_tracking.hover import read_indexed_hover
...
def test_selector_is_resolved_from_indexing_instruction(tmp_path):
    ...
    from inventory_tracking.hover_probe import discover_selector
