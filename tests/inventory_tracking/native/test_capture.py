...
from inventory_tracking.native.capture import capture_ranges, scan_unit_table
...
def test_restart_after_capture_suppresses_signature_results():
    ...
    with (
        ...
        patch(
            'inventory_tracking.native.capture_probe.identity',
        ...
        patch(
            'inventory_tracking.native.capture_probe.os.pread',
