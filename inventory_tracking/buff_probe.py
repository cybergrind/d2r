"""Host-only raw buff research: uv run -m inventory_tracking.buff_probe.
...
from .common import LOG, configure_logging, log_to_file, timestamp
...
from .unit_probe import ResearchReader, sample_units
from .units import read_stats, unit_matches
